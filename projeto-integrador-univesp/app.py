...
def get_cred_file_path():
    # Verifica se estamos rodando no modo "frozen" usando o PyInstaller
    if getattr(sys, 'frozen', False):
        # Se for o caso, o caminho é o diretório onde o executável está localizado
        application_path = sys._MEIPASS
    else:
        # Caso contrário, apenas use o diretório atual do script
